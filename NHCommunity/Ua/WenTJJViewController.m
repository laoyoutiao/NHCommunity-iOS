...
#import "WenTJJViewController.h"
#import "WentjjBiz.h"
#import "CommunityNewsTableViewCell.h"
#import "BDL_WebDetailViewController.h"

@interface WenTJJViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation WenTJJViewController
...
- (NSDictionary *)getParmWithStatu:(NSInteger)stautu{
    ...
    NSString *channleId = [NSString stringWithFormat:@"%@",@(98)];

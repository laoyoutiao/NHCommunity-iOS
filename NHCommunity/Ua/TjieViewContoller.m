...
typedef void(^DidSelectCellBlock)();

@interface TjieViewContoller ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation TjieViewContoller
...
- (NSDictionary *)getParmWithStatu:(NSInteger)stautu{
    ...
    NSString *channleId = [NSString stringWithFormat:@"%@",@(463)];
